...
const TuningCard: React.FC<{
  ...
  return (
    <div className={`absolute inset-0 flex items-center justify-center p-3 sm:p-4 bg-gray-800/60 rounded-2xl shadow-2xl-dark border border-white/10 backdrop-blur-sm ${animationClass}`} style={{ animationDuration: '0.6s' }}>
      <div className="w-full flex flex-col gap-6">
        ...
        {/* Like/Dislike Buttons - Below preview */}
        <div className="flex justify-center items-center gap-6">
          <Button
            onClick={() => onFeedback('dislike')}
            className="bg-red-600/90 hover:bg-red-500 border-2 border-red-400/50 text-white w-20 h-20 sm:w-24 sm:h-24 rounded-full shadow-2xl transform hover:scale-110 transition-all duration-300 flex items-center justify-center"
            aria-label="Dislike"
          >
            <span className="text-4xl sm:text-5xl" role="img" aria-hidden="true">👎</span>
          </Button>
          <Button
            onClick={() => onFeedback('like')}
            className="bg-green-600/90 hover:bg-green-500 border-2 border-green-400/50 text-white w-20 h-20 sm:w-24 sm:h-24 rounded-full shadow-2xl transform hover:scale-110 transition-all duration-300 flex items-center justify-center"
            aria-label="Like"
          >
            <span className="text-4xl sm:text-5xl" role="img" aria-hidden="true">👍</span>
          </Button>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-secondary-dark to-gray-900 text-white page-fade-enter flex flex-col">
      <div className="w-full max-w-xl mx-auto py-10 px-4 sm:px-6 lg:px-8 flex-grow flex flex-col">
        ...
        <div className="flex-grow w-full flex flex-col items-center justify-center py-4">
          <div className={`relative w-full max-w-sm transition-all duration-500 ease-in-out-sine ${isLoading ? 'h-64' : 'h-[600px]'}`}>
